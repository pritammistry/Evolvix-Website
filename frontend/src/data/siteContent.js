...
export const products = [
  ...
  { id: "buildx-hrms-tracker", slug: "buildx-hrms-tracker", type: "service", title: "Employee Attendance & HRMS Tool", category: "BuildX", tag: "On-Demand", description: "Custom Android attendance app with geofenced check-in/out, OOO approvals, break tracking, and automated Excel reports — built for retail and field teams.", image: "https://images.unsplash.com/photo-1521737711867-e3b97375f902?auto=format&fit=crop&w=1200&q=80", benefits: ["Geofenced check-in / check-out", "OOO & leave approval workflow", "Automated Excel attendance reports"], included: ["Android app", "Admin dashboard", "Break & OOO tracking", "Excel export"], fileSlots: [] },
...
export const fallbackSiteContent = {
  ...
  demos: [
    ...
    { id: "unlock-file-delivery", title: "Unlock — Payment-Locked File Delivery", industry: "Freelancers / Digital Services", description: "Stop chasing payments after delivery. Send your client a personal link where their files stay locked until you confirm payment — then unlock instantly with a 15-day download window. Built for anyone delivering digital work.", features: ["Files locked until payment is confirmed", "WhatsApp order confirmation with invoice link", "15-day download window with live countdown", "Multiple orders per customer", "Special permission — 2-day grace access", "Admin dashboard with payment-due tracking"], url: "https://evolvix-unlock-demo.vercel.app/c/demo-rahul-sharma/cv-package-locked", primary_label: "View Customer Experience", secondary_url: "https://evolvix-unlock-demo.vercel.app/admin/login", secondary_label: "View Admin Panel", note: "Admin demo login — demo@evolvixtech.in / demo1234", icon_key: "lock", status: "Live Demo", visible: true },
  ...
  contact_page: {
    ...
    inquiry_types: [
      "Business inquiry", "AI Business Consulting", "Creative Digital Services",
      "Website / App / Software", "Learning and Growth Product Support",
      "Music for Creators", "Branding / Portfolio / Resume", "Collaboration inquiry",
    ],
    form: {
