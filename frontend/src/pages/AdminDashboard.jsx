...
import { Lock, Save, RotateCcw, Plus, Trash2, Sparkles, Database, Layers3, Package, Newspaper, Image as ImageIcon, LogOut, UploadCloud } from "lucide-react";
...
export default function AdminDashboard() {
  ...
  const tabs = useMemo(() => ["brand", "services", "ecosystem", "learning", "music", "custom", "products", "portfolio", "blog"], []);
