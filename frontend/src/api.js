...
export const validatePromoCode = (payload) => axios.post(`${API}/promo/validate`, payload);
export const fetchAdminPromoCodes = () => axios.get(`${API}/admin/promo-codes`);
export const createAdminPromoCode = (payload) => axios.post(`${API}/admin/promo-codes`, payload);
export const updateAdminPromoCode = (id, payload) => axios.put(`${API}/admin/promo-codes/${id}`, payload);
export const deleteAdminPromoCode = (id) => axios.delete(`${API}/admin/promo-codes/${id}`);
...
export const reorderPlayground = (ids) => axios.post(`${API}/admin/playground/reorder`, { ids });
