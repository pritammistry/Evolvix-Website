...
export default function Contact() {
  ...
  const [form, setForm] = useState({ name: "", email: "", inquiry_type: prefillType, message: prefillService ? `Hi, I'm interested in ${prefillService}.` : "" });
